...
<head>
    ...
    <title>Form Pembelian Detail</title>
</head>
<body>
    <h2>Form Pembelian Detail</h2>
    <form action="proses_pembelian_detail.php" method="POST">
        <label for="beli_detail_id">ID Pembelian Detail:</label><br>
        <input type="text" id="beli_detail_id" name="beli_detail_id"><br>

        <label for="pembelian_id">ID Pembelian:</label><br>
        <input type="text" id="pembelian_id" name="pembelian_id"><br>
        ...
        <label for="created_at">Tanggal Pembelian:</label><br>
        <input type="datetime-local" id="created_at" name="created_at"><br>
